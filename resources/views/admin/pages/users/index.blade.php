    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        ...
        <div class="dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink" style="">
                ...
                <a class="dropdown-item" href="{{url('/admin/users/add')}}">Tambah</a>
            </div>
        </div>
    </div>
    <!-- Card Body -->
...
<div class="modal" tabindex="-1" id="mdl-remove-user">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <p>Anda yakin akan menghapus user '<span id="mdl-param-name"></span>'</p>
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
            <form id="form-mdl-remove-user" method="POST" action="">
                @csrf
...
$(function(){
    $('#list_data').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: `{{url('/admin/users/list')}}`, // URL to fetch data from server
                    ...
                    var str =`
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="actionDropdown-${row.id}">
                                <a class="dropdown-item" href="{{url('/admin/users/update/')}}/${row.id}"><i class="fas fa-edit"></i> Edit</a>
                                <a class="dropdown-item" onclick="showRemove('${row.id}','${row.name}')" href="#remove-user"><i class="fas fa-trash"></i> Hapus</a>
...
function showRemove(id,name){
    ...
    $('#form-mdl-remove-user').attr('action',`{{url('/admin/users/remove')}}/`+id)
