...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Form Tambah Konten</h6>

    </div>
    <!-- Card Body -->
    <div class="card-body">
        <form method="POST" action="{{url('/admin/content/add')}}" enctype="multipart/form-data" autocomplete="off" class="@if($errors->any()) needs-validation was-validated @endif" novalidate>
            @csrf
            <div class="row">
                <div class="col-8">
                    <div class="form-group">
                        <label for="input_judul">Judul :</label>
                        <input type="text" name="judul" class="form-control" id="input_judul" placeholder="Masukan judul" required>
                        @error('judul')
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="3" id="input_konten" class="form-control" name="konten"></textarea>
                        @error('konten')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
